                              ...
                              <div class="item item-first">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             <h3></h3>
                                             <h1>Patient Registratio</h1>
                                             <center> <form action="patient_reg" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                                    <table>
                                        <tr><td style="color: black">Patient Name:</td><td style="color: black"><input type="text" required name="name" pattern="[A-Za-z]+" title="Name should not contain integer value"/></tb></tr>
