                              ...
                              <div class="item item-first">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             <h3></h3>
                                             <h1>Cloud Login</h1>
                                             <form action="CloudLoginCheck.jsp" method="post">
                                    <h5 style="color:black">UserName:&nbsp;&nbsp;<input type="text" required name="cname"/></h5><br>
                                    <h5 style="color:black">Password:&nbsp;&nbsp;<input type="password" required name="cpass"/></h5><br>
