          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="doctorlogin.jsp" class="smoothScroll">DOCTOR</a></li>
                              ...
                              <div class="item item-first">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             <h3></h3>
                                             <h1>A Survey on Health Care facilities by Cloud
Computing</h1>
