...
/**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sqlQuery = "Select status , accesskey , email  from doctorregister where name = ? and password = ?";
            ...
            if(status.equalsIgnoreCase("activated")){
                ...
                response.sendRedirect("doctorlogin.jsp?msg=notactivated");
            }
        }
        catch(Exception e){
            System.out.println(e.getMessage());
            response.sendRedirect("doctorlogin.jsp?msg=notexist");
        } 
    }
